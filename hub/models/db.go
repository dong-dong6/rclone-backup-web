...
func ensureSchema(ctx context.Context, pool *pgxpool.Pool) error {
	statements := []string{
		...
		`ALTER TABLE backup_tasks ADD COLUMN IF NOT EXISTS db_dump_mode TEXT`,
		...
		`ALTER TABLE backup_tasks DROP CONSTRAINT IF EXISTS backup_tasks_db_dump_mode_check`,
		`ALTER TABLE backup_tasks ADD CONSTRAINT backup_tasks_db_dump_mode_check CHECK (db_dump_mode IS NULL OR db_dump_mode IN ('single','all'))`,
